...
public class EvilOcean {
    ...
    public void preinit(FMLPreInitializationEvent event) {
        ...
        try {
            ...
            // treasureItems = config.getStringList("items", "treasure", new
            // String[] {"minecraft:gold_nugget:0=50,1:4",
            // "minecraft:melon_seeds:0=10,1:10",
            // "minecraft:gold_ingot:0=10,1:2",
            // "minecraft:golden_apple:0=10,1:1"}, "List of items to use in
            // treasure generation. Use this format:
            // modid:itemName:metaId=weight,qtyMin:qtyMax");
