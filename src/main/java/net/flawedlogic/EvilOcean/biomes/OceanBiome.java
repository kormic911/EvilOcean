...
public abstract class OceanBiome extends Biome {
	...
	public static void registerBiomes() {
		...
		//registerBiome(80, "eo_deep_ocean", new BiomeBigOcean((new Biome.BiomeProperties("Ocean")).setBaseHeight(-1.8F).setHeightVariation(0.1F).setWaterColor(112)));
		...
		registerBiome(82, "mountain_ocean", new BiomeMountainIslands((new Biome.BiomeProperties("Ocean")).setBaseHeight(-1.5F).setHeightVariation(0.2F).setRainfall(0.3F).setTemperature(0.2F).setWaterColor(112)));
		...
		registerBiome(84, "taiga_ocean", new BiomeBigOcean((new Biome.BiomeProperties("Ocean")).setBaseHeight(-1.5F).setHeightVariation(0.2F).setRainfall(0.8F).setTemperature(0.5F).setSnowEnabled().setWaterColor(1456435)));
