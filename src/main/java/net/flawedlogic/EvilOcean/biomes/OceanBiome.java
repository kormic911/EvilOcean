...
public abstract class OceanBiome extends Biome {
	...
	public static void registerBiomes() {
		...
		registerBiome(82, "mountain_ocean", new BiomeGenOceanLilypads((new Biome.BiomeProperties("Ocean")).setBaseHeight(-1.5F).setHeightVariation(0.2F).setRainfall(0.3F).setTemperature(0.2F).setWaterColor(112)));
