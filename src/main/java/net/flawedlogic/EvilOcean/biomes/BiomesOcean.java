...
public abstract class BiomesOcean extends BiomeGenBase {
	...
	public static final BiomeGenBase taigaOcean = new BiomeGenBigOcean(84).setColor(1456435).setBiomeName("Ocean").func_76733_a(5159473).setEnableSnow().setTemperatureRainfall(0.05F, 0.8F).setHeight(height_normalOcean);
	...
	public static final BiomeGenBase megaTaigaOcean = new BiomeGenBigOcean(98).setColor(1456435).setBiomeName("Ocean").func_76733_a(5159473).setEnableSnow().setTemperatureRainfall(0.05F, 0.8F).setHeight(height_normalOcean);
	...
	public static final BiomeGenBase forestIslands = new BiomeGenForestIsland(86, 0).setColor(2250012).setBiomeName("Forest Island").func_76733_a(5159473).setTemperatureRainfall(0.7F, 0.8F).setHeight(height_normalIsland);
	...
	public static final BiomeGenBase jungleIslands = new BiomeGenJungleIsland(89).setColor(2900485).setBiomeName("Jungle Island").func_76733_a(5470985).setTemperatureRainfall(1.2F, 0.9F).setHeight(height_normalIsland);
