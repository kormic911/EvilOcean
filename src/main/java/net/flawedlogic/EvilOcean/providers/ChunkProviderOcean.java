...
public class ChunkProviderOcean implements IChunkGenerator {
    ...
    public ChunkProviderOcean(World worldIn, long seed, boolean mapFeaturesEnabledIn, String p_i46668_5_)
    {
        {
    ...
    {
        this.depthRegion = this.depthNoise.generateNoiseOctaves(this.depthRegion, p_185978_1_, p_185978_3_, 5, 5, 200.0D, 200.0D, 0.5D);
        this.mainNoiseRegion = this.mainPerlinNoise.generateNoiseOctaves(this.mainNoiseRegion, p_185978_1_, p_185978_2_, p_185978_3_, 5, 33, 5, 8.555150000000001D, 4.277575000000001D, 8.555150000000001D);
        this.minLimitRegion = this.minLimitPerlinNoise.generateNoiseOctaves(this.minLimitRegion, p_185978_1_, p_185978_2_, p_185978_3_, 5, 33, 5, 684.41200000000003D, 684.41200000000003D, 684.41200000000003D);
        this.maxLimitRegion = this.maxLimitPerlinNoise.generateNoiseOctaves(this.maxLimitRegion, p_185978_1_, p_185978_2_, p_185978_3_, 5, 33, 5, 684.41200000000003D, 684.41200000000003D, 684.41200000000003D);
        int i = 0;
        int j = 0;
        ...
        for (int k = 0; k < 5; ++k)
        {
            for (int l = 0; l < 5; ++l)
            {
                ...
                for (int l1 = 0; l1 < 33; ++l1)
                {
                    ...
                    double d2 = this.minLimitRegion[i] / 512.0D;
                    double d3 = this.maxLimitRegion[i] / 512.0D;
    ...
    public void populate(int x, int z)
    {
        ...
        if (biome != Biomes.DESERT && biome != Biomes.DESERT_HILLS && !flag && this.rand.nextInt(10) == 0)
        ...
        if (!flag && this.rand.nextInt(10) == 0 )
        if (net.minecraftforge.event.terraingen.TerrainGen.populate(this, this.world, this.rand, x, z, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.LAVA))
        {
            ...
            if (l2 < this.world.getSeaLevel() || this.rand.nextInt(8) == 0)
            {
    ...
    public BlockPos getStrongholdGen(World worldIn, String structureName, BlockPos position, boolean p_180513_4_)
    {
        ...
        return !this.mapFeaturesEnabled ? null : ("Stronghold".equals(structureName) && this.strongholdGenerator != null ? this.strongholdGenerator.getClosestStrongholdPos(worldIn, position, p_180513_4_) : ("Monument".equals(structureName) && this.oceanMonumentGenerator != null ? this.oceanMonumentGenerator.getClosestStrongholdPos(worldIn, position, p_180513_4_) : ("Village".equals(structureName) && this.villageGenerator != null ? this.villageGenerator.getClosestStrongholdPos(worldIn, position, p_180513_4_) : ("Mineshaft".equals(structureName) && this.mineshaftGenerator != null ? this.mineshaftGenerator.getClosestStrongholdPos(worldIn, position, p_180513_4_) : ("Temple".equals(structureName) && this.scatteredFeatureGenerator != null ? this.scatteredFeatureGenerator.getClosestStrongholdPos(worldIn, position, p_180513_4_) : null)))));
    }
    ...
    public boolean generateStructures(Chunk chunkIn, int x, int z)
    {
        ...
        if (this.mapFeaturesEnabled && chunkIn.getInhabitedTime() < 3600L)
        {
