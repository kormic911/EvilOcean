...
public class ChunkProviderOcean implements IChunkGenerator {
    ...
    public void populate(int x, int z)
    {
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.populate(this, this.worldObj, this.rand, x, z, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.LAVA))
        {
            ...
            if (l2 < this.worldObj.getSeaLevel() || this.rand.nextInt(10) == 0)
            {
    ...
    public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos)
    {
        ...
        if (this.mapFeaturesEnabled)
        {
            ...
            if (creatureType == EnumCreatureType.MONSTER && this.oceanMonumentGenerator.isPositionInStructure(this.worldObj, pos))
            {
